 ...
 * @final
 */
class ControllerAhuangLoremIpsumControllerKernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'ahuang_lorem_ipsum.ahuang_ipsum' => 'getAhuangLoremIpsum_AhuangIpsumService.php',
            'ahuang_lorem_ipsum.ahuang_ipsum_api_controller' => 'getAhuangLoremIpsum_AhuangIpsumApiControllerService.php',
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/ControllerAhuangLoremIpsumControllerKernelTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.logs_dir' => (\dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'var'.\DIRECTORY_SEPARATOR.'log'),
            'kernel.bundles' => [
                'AhuangLoremIpsumBundle' => 'Ahuang\\LoremIpsumBundle\\AhuangLoremIpsumBundle',
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
            ],
            'kernel.bundles_metadata' => [
                'AhuangLoremIpsumBundle' => [
                    'path' => (\dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'),
            ...
            'kernel.container_class' => 'ControllerAhuangLoremIpsumControllerKernelTestDebugContainer',
            ...
            'router.cache_class_prefix' => 'ControllerAhuangLoremIpsumControllerKernelTestDebugContainer',
